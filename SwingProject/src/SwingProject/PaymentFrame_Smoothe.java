...
public class PaymentFrame_Smoothe extends PaymentFrame {
    public PaymentFrame_Smoothe(JButton buttonMenu) {
        super(buttonMenu, "smoothe", "jpg");
...
class payActinonListenerSmoothe implements ActionListener {
    public void actionPerformed(ActionEvent e) {
        JButton buttonPayMenu = (JButton) e.getSource();
        new PaymentFrame_Smoothe(buttonPayMenu);
    }
}
